...
export type MMTab = { id: string; icon: string; label: string; desc: string; groups: MMGroup[]; comingSoon?: boolean };
    ...
    tabs: [
      {
        ...
        desc: "Minh hoạ Bộ GD · 34 tỉnh · Trường chuyên",
        groups: [
          { title: "ĐỀ MINH HOẠ BỘ GD&ĐT", items: [
            { name: "Đề minh hoạ 2026", sub: "Bộ GD&ĐT công bố", tag: "NEW" },
            { name: "Cấu trúc đề mới", sub: "Phân tích chi tiết format 2026" },
            { name: "Bộ đề bám sát minh hoạ", sub: "Luyện theo format chuẩn" },
            { name: "Đáp án + lời giải", sub: "Giải chi tiết từng câu" },
            { name: "So sánh 2025 vs 2026", sub: "Điểm mới cần lưu ý", tag: "HOT" },
            { name: "Tài liệu ôn theo cấu trúc", sub: "PDF + video chữa đề" },
          ]},
          { title: "ĐỀ TỈNH / THÀNH (34 TỈNH)", items: [
            { name: "Đề Hà Nội", sub: "Sở GD&ĐT TP. Hà Nội", tag: "HOT" },
            { name: "Đề TP. Hồ Chí Minh", sub: "Sở GD&ĐT TP. HCM", tag: "HOT" },
            { name: "Đề Hải Phòng", sub: "Sở GD&ĐT TP. Hải Phòng" },
            { name: "Đề Đà Nẵng", sub: "Sở GD&ĐT TP. Đà Nẵng" },
            { name: "Đề Cần Thơ", sub: "Sở GD&ĐT TP. Cần Thơ" },
            { name: "Đề Huế", sub: "Sở GD&ĐT TP. Huế" },
            { name: "Xem tất cả 34 tỉnh thành", sub: "Tra cứu theo địa phương", tag: "NEW" },
          ]},
          { title: "TRƯỜNG CHUYÊN & THI THỬ", items: [
            { name: "Chuyên Sư phạm Hà Nội", sub: "Đề thi thử + chính thức" },
            { name: "Chuyên Ngoại ngữ — ĐHQG HN", sub: "Bộ đề các năm" },
            { name: "Chuyên KHTN — ĐHQG HN", sub: "Đề Tiếng Anh chuyên" },
            { name: "Chuyên Lê Hồng Phong", sub: "TP.HCM — chuyên Anh", tag: "HOT" },
            { name: "PTNK — ĐHQG-HCM", sub: "Đề mở rộng" },
            { name: "Liên trường Hà Nội", sub: "Khảo sát chung tháng 3" },
            { name: "Thi thử online", sub: "Mô phỏng phòng thi thật" },
            { name: "Xem tất cả trường chuyên", sub: "Danh sách đầy đủ" },
          ]},
        ],
      },
      {
        ...
        groups: [
          ...
          { title: "ĐỀ MINH HOẠ", items: [
            { name: "Đề minh hoạ", sub: "Đề + đáp án + lời giải", tag: "NEW" },
            { name: "Phân tích cấu trúc", sub: "Bóc tách dạng bài & tỉ trọng" },
            { name: "Bộ đề minh hoạ theo cấu trúc", sub: "Luyện bám sát đề mẫu" },
          ]},
        ],
      },
      {
