    ...
    tabs: [
      {
        ...
        groups: [
          { title: "ĐỀ CHÍNH THỨC", items: [
            { name: "2026", sub: "Đề Sở GD năm 2026", tag: "NEW" },
            { name: "2025", sub: "Đề Sở GD năm 2025", tag: "HOT" },
            { name: "2024", sub: "Đề Sở GD năm 2024" },
            { name: "2023", sub: "Đề Sở GD năm 2023" },
            { name: "2022", sub: "Đề Sở GD năm 2022" },
            { name: "Archive 2015 – 2021", sub: "Lưu trữ theo từng năm" },
          ]},
          { title: "ĐỀ THI THỬ", items: [
            { name: "Chuyên Sư phạm", sub: "Đề thi thử các lượt" },
            { name: "Chuyên Ngoại ngữ", sub: "ĐHQG Hà Nội" },
            { name: "Chuyên KHTN", sub: "ĐHQG Hà Nội" },
            { name: "Lê Hồng Phong", sub: "TP.HCM — chuyên Anh" },
            { name: "PTNK", sub: "ĐHQG-HCM" },
            { name: "Liên trường HN", sub: "Khảo sát chung tháng 3" },
          ]},
          { title: "ĐỀ MINH HOẠ", items: [
            { name: "1. Đề + đáp án + giải", sub: "Bộ GD&ĐT công bố", tag: "NEW" },
            { name: "2. Phân tích cấu trúc", sub: "Bóc tách dạng bài & tỉ trọng" },
            { name: "3. Bộ đề minh hoạ theo cấu trúc", sub: "Luyện bám sát đề mẫu" },
          ]},
        ],
      },
      {
