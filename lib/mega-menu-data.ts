        ...
        groups: [
          {
            ...
            slots: [
              ...
              { kind: "dynamic-exam" as const, href: (s: string) => `/de-thi-chi-tiet/${s}` },
              { kind: "dynamic-exam" as const, href: (s: string) => `/de-thi-chi-tiet/${s}` },
              { kind: "static" as const, name: "2026", sub: "Đề Sở GD năm 2026", href: "/kho-de-thi?cat=vao-10&examType=chinh-thuc&year=2026" },
              { kind: "static" as const, name: "2025", sub: "Đề Sở GD năm 2025", href: "/kho-de-thi?cat=vao-10&examType=chinh-thuc&year=2025" },
              { kind: "static" as const, name: "Archive 2015 – 2024", sub: "Lưu trữ theo từng năm", href: "/kho-de-thi?cat=vao-10&examType=chinh-thuc&yearMax=2024" },
            ] as ItemSlot[],
          },
          {
            title: "ĐỀ THI THỬ",
        ...
        groups: [
          {
            ...
            slots: [
              ...
              { kind: "dynamic-exam" as const, href: (s: string) => `/de-thi-chi-tiet/${s}` },
              { kind: "dynamic-exam" as const, href: (s: string) => `/de-thi-chi-tiet/${s}` },
              { kind: "static" as const, name: "THPT QG 2026", sub: "Mã đề + đáp án Bộ GD", href: "/kho-de-thi?cat=vao-dai-hoc&examType=chinh-thuc&year=2026" },
              { kind: "static" as const, name: "THPT QG 2025", sub: "Mã đề + đáp án Bộ GD", href: "/kho-de-thi?cat=vao-dai-hoc&examType=chinh-thuc&year=2025" },
              { kind: "static" as const, name: "Lưu trữ 2017 – 2024", sub: "Theo từng năm", href: "/kho-de-thi?cat=vao-dai-hoc&examType=chinh-thuc&yearMax=2024" },
            ] as ItemSlot[],
          },
          {
            title: "Đề thi thử",
