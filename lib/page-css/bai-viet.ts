export const BAI_VIET_CSS = String.raw`
  ...
  .feat-side-item .img { width: 160px; flex-shrink: 0; background: linear-gradient(135deg,#DBEAFE,#BFDBFE); display: flex; align-items: center; justify-content: center; font-size: 36px; }
  .feat-side-item:nth-child(2) .img { background: linear-gradient(135deg,#FEF3C7,#FDE68A); }
  ...
  .post-card .tag-pill { display: inline-block; align-self: flex-start; font-size: 11px; font-weight: 700; color: var(--red); background: var(--red-light); padding: 3px 10px; border-radius: 6px; margin-bottom: 10px; }
